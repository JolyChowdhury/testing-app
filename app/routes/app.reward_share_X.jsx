...
export default function ShareXReward() {
  const navigate = useNavigate();
  // popup content
  const OpenShareXModal = useAppBridge();
  const handleModalRewardShareXToggle = () => {
    OpenShareXModal.modal.show("my-modal");
  };

  // State for Share X Page URL
  const [ShareXFieldValue, setShareXFieldValue] = useState("");
  const handleShareXFieldChange = useCallback(
    (value) => setShareXFieldValue(value),
    [],
  );
  ...
  const [modalRewardShareXValue, setModalRewardShareXValue] = useState("");
  const handleModalRewardShareXValueChange = useCallback(
    (newModalRewardInstagramValue) =>
      setModalRewardShareXValue(newModalRewardInstagramValue),
    [],
  );
                  ...
                  <Card roundedAbove="sm">
                    <BlockStack gap="50">
                      ...
                      >
                        ...
                        <text onClick={handleModalRewardShareXToggle}>
                          Set name
                        </text>
                      </div>
                      {/* <Modal
                      ...
                      <Form>
                        <Modal id="my-modal">
                          ...
                          >
                            <TextField
                              label="Rewards name"
                              value={modalRewardShareXValue}
                              onChange={handleModalRewardShareXValueChange}
                              autoComplete="off"
                            />
                          </div>
                        </Modal>
                    ...
                    <div style={{ marginBottom: "20px" }}>
                      <Card roundedAbove="sm">
                        <BlockStack gap="400">
                          ...
                          <TextField
                            label="URL to share"
                            value={ShareXFieldValue}
                            onChange={handleShareXFieldChange}
