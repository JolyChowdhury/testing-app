...
// render for real live reward race
...
export default function rewardProgram() {
  ...
  // Switch Button states and handlers
  ...
  const [toggleLikeFacebookActive, setToggleLikeFacebookActive] =
    useState(false);
  const handleLikeFacebookToggle = () =>
    setToggleLikeFacebookActive((prevState) => !prevState);

  const [toggleInstagramActive, setToggleInstagramActive] = useState(false);
  const handleInstagramToggle = () =>
    setToggleInstagramActive((prevState) => !prevState);

  const [toggleTwitterActive, setToggleTwitterActive] = useState(false);
  const handleTwitterToggle = () =>
    setToggleTwitterActive((prevState) => !prevState);

  const [toggleShareFacebookActive, setToggleShareFacebookActive] =
    useState(false);
  const handleShareFacebookToggle = () =>
    setToggleShareFacebookActive((prevState) => !prevState);

  const [toggleShareXActive, setToggleShareXActive] = useState(false);
  const handleShareXToggle = () =>
    setToggleShareXActive((prevState) => !prevState);
    ...
    <div key="reward">
      ...
      >
        ...
        >
          ...
          >
            <div style={{ display: "flex", alignItems: "center" }}>
              <Button onClick={handleToggle} plain ariaPressed={toggleActive}>
                <Text variation="strong">
              ...
              <div
                ...
                style={{
                  ...
                  width: "50px",
                  height: "25px",
                  background: toggleActive ? "#4caf50" : "#ccc",
                  borderRadius: "25px",
                  position: "relative",
                  cursor: "pointer",
                  marginLeft: "10px",
